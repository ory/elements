...
export const ShowForm: Story = {
  args: {
    flow: LoginFlowFromJSON(
      require("$snapshots/login/1fa/code/initial-form.json"),
    ),
    config,
  },
}
...
export const ValidationMissingFields: Story = {
  args: {
    flow: LoginFlowFromJSON(
      require("$snapshots/login/1fa/code/missing-email.json"),
    ),
    config,
  },
}
...
export const ValidationInvalidAccount: Story = {
  args: {
    flow: LoginFlowFromJSON(
      require("$snapshots/login/1fa/code/invalid-account.json"),
    ),
    config,
  },
}
...
export const CodeInput: Story = {
  args: {
    flow: LoginFlowFromJSON(
      require("$snapshots/login/1fa/code/code-input.json"),
    ),
    config,
  },
}

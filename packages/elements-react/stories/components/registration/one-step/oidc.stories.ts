...
const meta = {
  title: "Ory Elements/Registration/Unified/OIDC",
...
export const ShowForm: Story = {
  args: {
    flow: RegistrationFlowFromJSON(
      require("$snapshots/registration/one-step/oidc/initial-form.json"),
    ),
    config,
  },
}
...
export const ValidationError: Story = {
  args: {
    flow: LoginFlowFromJSON(
      require("$snapshots/registration/one-step/oidc/missing-fields.json"),
    ),
    config,
  },
}

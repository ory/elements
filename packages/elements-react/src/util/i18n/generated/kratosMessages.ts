...
const KNOWN_KRATOS_MESSAGE_IDS = [
  ...
  4000045, 4000046, 4010001, 4010002, 4010003, 4010004, 4010005, 4010006,
  4010007, 4010008, 4010009, 4010010, 4010011, 4040001, 4040002, 4040003,
  4050001, 4050002, 4060001, 4060002, 4060004, 4060005, 4060006, 4070001,
  4070002, 4070003, 4070005, 4070006, 5000001, 5000002, 5000003,
] as const
...
export const kratosMessages = defineMessages<number>({
  ...
  4000046: {
    id: "identities.messages.4000046",
    defaultMessage: `This DeviceAuthn key was enrolled before user verification was introduced and can no longer be used. Please enroll your device again.`,
  },
  4010001: {

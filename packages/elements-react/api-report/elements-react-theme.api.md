...
// @public
export function Consent({ consentChallenge, session, config, components: Passed, children, csrfToken, formActionUrl, }: PropsWithChildren<ConsentFlowProps>): react_jsx_runtime.JSX.Element;
...
//
// dist/theme/default/index.d.ts:114:5 - (ae-forgotten-export) The symbol "OryClientConfiguration" needs to be exported by the entry point index.d.ts
// dist/theme/default/index.d.ts:137:5 - (ae-forgotten-export) The symbol "OryFlowComponentOverrides" needs to be exported by the entry point index.d.ts

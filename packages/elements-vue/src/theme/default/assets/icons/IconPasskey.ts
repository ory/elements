...
export const IconPasskey = defineComponent({
  name: "IconPasskey",
  props: {
    size: {
      type: Number,
  ...
  setup(props) {
    // Scale factor to normalize from 13x14 viewBox to props.size
    return () =>
      h(
        "svg",
        {

...
/**
 * Generates a URL to restart the current flow.
 *
 * @param flow - The current flow
 * @param fallback - Fallback URL if request_url is not available
 */
...
/**
 * Generates a URL to initialize a new flow.
 *
 * @param sdkUrl - The SDK base URL
 * @param flowType - The flow type (login, registration, etc.)
 * @param flow - The current flow for context (return_to, etc.)
 */

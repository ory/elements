...
/**
 * Minimal translator interface returned by {@link useOryIntl}.
 * Keeps the emitted declaration independent from vue-i18n internals.
 */
export type OryTranslator = {
 ...
 */
export function useOryIntl(): OryTranslator {

...
_Please note_: We take ORY Themes's security and our users' trust very
seriously. If you believe you have found a security issue in ORY Themes,
...
do this is via
[ORY Themes Discussions](https://github.com/ory/meta/discussions)
...
- I have a question. Where can I get
  [answers to questions regarding ORY Themes?](#communication)
...
- I want to talk to other ORY Themes users.
...
- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out ORY Themes.
...
- **Helping with open issues.** We have a lot of open issues for ORY Themes
...
Check out [ORY Themes Discussions](https://github.com/ory/meta/discussions). This is a great place for
...
If you want to receive regular notifications about updates to ORY Themes,
...
before getting started to ensure your work is consistent with ORY Themes's
...
[docs](https://github.com/ory/themes/tree/master/docs) folder. Generate API and
configuration reference documentation using `cd docs; npm run gen`.

For further instructions please head over to
[docs/README.md](https://github.com/ory/themes/blob/master/README.md).
...
1. Ensure that each commit has a subsystem prefix (ex: `controller:`).
   [List of subsystem prefixes for Themes](https://github.com/ory/ory/themes/blob/master/.github/semantic.yml)
   (if applicable).
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  member, please contact one of the channel ops or a member of the ORY Themes

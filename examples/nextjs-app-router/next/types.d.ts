export interface Config {
  ...
  // TODO - we need to fetch the original login ui from the project config.
   ...
   * `/my-registration`.
   */
  custom_registration_ui_path?: string
   ...
   * `/my-recovery`.
   */
  custom_recovery_ui_path?: string
   ...
   * `/my-verification`.
   */
  custom_verification_ui_path?: string
   ...
   * `/my-settings`.
   */
  custom_settings_ui_path?: string
}
